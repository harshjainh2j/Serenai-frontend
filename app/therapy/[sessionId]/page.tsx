...
return (
  <div className="relative max-w-7xl mx-auto px-4">
      ...
      {showSidebar && (
        ...
        >
          ...
          >
            ...
            <ScrollArea className="h-[80vh] space-y-2">
              {sessions.map((s) => (
                <Button
                  key={s.sessionId}
                  variant="outline"
                  className="w-full justify-start gap-2"
                  onClick={() => { handleSessionSelect(s.sessionId); setShowSidebar(false); }}
                >
                  <MessageSquare className="w-4 h-4" />
              ...
              <Button
                ...
                onClick={() => { handleNewSession(); setShowSidebar(false); }}
              >
    ...
    <div className="flex flex-col md:flex-row h-[calc(100vh-4rem)] mt-20 gap-4 md:gap-6">
      {/* Desktop Sidebar (>=md) */}
      <div className="hidden md:flex md:w-80 flex-col border-r bg-muted/30">
        <div className="p-4 border-b flex items-center justify-between">
          <h2 className="text-lg font-semibold">Chat Sessions</h2>
              ...
              <div className="grid gap-3 relative">
                ...
                {SUGGESTED_QUESTIONS.map((q, idx) => (
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full py-4 px-6 text-left hover:bg-muted/50 hover:border-primary/50 transition-all duration-300"
                      onClick={() => handleSuggestedQuestion(q.text)}
                    >
                      {q.text}
                    </Button>
        ...
        <div className="border-t bg-background/50 backdrop-blur supports-[backdrop-filter]:bg-background/50 p-4">
          ...
          >
            <textarea
              ...
              className={cn(
                "w-full resize-none rounded-2xl border bg-background p-3 pr-12",
                "focus:outline-none focus:ring-2 focus:ring-primary/50",
